...
<div>
    <table width="100%">
        <tr>
            ...
            <td width="70%">
                <p class="centro grande_titulos_comp letra_titulos"><b>COMPOSICIÓN<br>REPRESENTANTES DE LAS NACIONES Y PUEBLOS INDÍGENAS ORIGINARIO CAMPESINOS ASAMBLEÍSTAS DEPARTAMENTALES</b></p>
            </td>
            <td width="15%">
...
<table width="100%" class="tablesinespacio letra">
    ...
    @include('composicion.autoridades_npioc')
</table>
