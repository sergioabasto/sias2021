...
class Candidato extends Model
{
    ...
    protected $fillable = [
        'IdCandidato','Nombres','PrimerApellido','SegundoApellido', 'DocumentoIdentidad', 'ComplementoSegip', 'LugarExpedido', 'Genero', 'Direccion', 'Telefono','FechaNacimiento','IsElecto', 'IdCargo', 'IdOrganizacionPolitica', 'IdProcesoElectoral', 'IdDepartamento', 'IdProvincia', 'IdMunicipio','created_at','updated_at',
    ];
